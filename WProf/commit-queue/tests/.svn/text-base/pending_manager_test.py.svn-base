...
def _try_comment(issue=31337):
  return (
      "add_comment(%d, '%shttp://localhost/author@example.com/%d/1\\n')" %
...
"""
  ...
  def testCommitBurst(self):
    ...
    self.context.checkout.check_calls([
      'prepare(None)',
      'apply_patch(%r)' % self.context.rietveld.patchsets[0],
      "commit(u'foo\\n\\nReview URL: http://nowhere/0', 'author@example.com')",
      'prepare(None)',
      'apply_patch(%r)' % self.context.rietveld.patchsets[1],
      "commit(u'foo\\n\\nReview URL: http://nowhere/1', 'author@example.com')",
      'prepare(None)',
      'apply_patch(%r)' % self.context.rietveld.patchsets[2],
      "commit(u'foo\\n\\nReview URL: http://nowhere/2', 'author@example.com')"])
    self.context.rietveld.check_calls(
        [ _try_comment(0),
          _try_comment(1),
          _try_comment(2),
    ...
    self.context.checkout.check_calls([
      ...
      "commit(u'foo\\n\\nReview URL: http://nowhere/3', 'author@example.com')"])
    self.context.rietveld.check_calls(
        [ 'close_issue(3)',
    ...
    self.context.checkout.check_calls([
      ...
      "commit(u'foo\\n\\nReview URL: http://nowhere/4', 'author@example.com')",
      'prepare(None)',
    ...
    self.context.rietveld.check_calls(
        [ 'close_issue(4)',
          "update_description(4, u'foo')",
          "add_comment(4, 'Change committed as 125')",
          'close_issue(31337)',
          "update_description(31337, u'foo')",
          "add_comment(31337, 'Change committed as 125')"])
